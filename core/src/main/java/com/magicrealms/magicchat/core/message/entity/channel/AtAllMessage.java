...
public class AtAllMessage extends ToppingAllMessage {
     ...
     */
    public AtAllMessage(@Nullable UUID sender, @Nullable String permissionNode, String content, int weight, long keepTick) {
        super(sender, permissionNode, content, weight, keepTick); // 调用父类构造函数
    }
}
