...
public class AtAllMessage extends ToppingAllMessage {
     ...
     */
    public AtAllMessage(@Nullable UUID sender, @Nullable String permissionNode, String content, long keepTick) {
        super(sender, permissionNode, content, keepTick); // 调用父类构造函数
    }
}
