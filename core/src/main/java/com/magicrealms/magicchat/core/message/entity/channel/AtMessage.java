...
public class AtMessage extends ToppingMessage {
     ...
     */
    public AtMessage(@Nullable UUID sender, @Nullable String permissionNode, String content, long keepTick, List<UUID> target) {
        super(sender, permissionNode, content, keepTick, target);
    }
}
