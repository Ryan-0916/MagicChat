...
public class AtMessage extends ToppingMessage {
     ...
     */
    public AtMessage(@Nullable UUID sender, @Nullable String permissionNode, String content, int priority, long keepTick, List<UUID> target) {
        super(sender, permissionNode, content, priority, keepTick, target);
    }
}
