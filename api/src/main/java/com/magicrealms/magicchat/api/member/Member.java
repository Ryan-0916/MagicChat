...
import com.magicrealms.magicchat.api.member.state.BlockState;
import com.magicrealms.magicchat.api.member.state.NoneBlockState;
import com.magicrealms.magicchat.api.member.state.SelectorBlockState;
import com.magicrealms.magicchat.api.member.state.TypewriterBlockState;
...
import com.magicrealms.magicchat.api.message.channel.AbstractToppingMessage;
import com.magicrealms.magicchat.api.message.channel.ToppingAllMessage;
import com.magicrealms.magicchat.api.message.channel.ToppingMessage;
...
public class Member {
    ...
    public Member(Player player, AbstractChannel channel) {
